...
export const formatBodyFeatureLayer = async (q: any, fields?: ICacheDataResult): Promise<IQuery> => {
    const clauseWhere = formatExpressionrQuery(q, fields);
    const queryFormatted = {
        query: clauseWhere
    };
    return queryFormatted;
...
export const formatExpressionrQuery = (q: any, fields?: ICacheDataResult): any => {
